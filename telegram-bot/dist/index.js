...
const todobot_1 = tslib_1.__importDefault(require("./todobot"));
const bots = new Map();
function getBot(ctx) {
    const chatId = ctx.chat.id;
    if (!bots.has(chatId)) {
        bots.set(chatId, new todobot_1.default(ctx));
    }
    return bots.get(chatId);
}
const bot = new telegraf_1.Telegraf('6318222489:AAFpan9BaHrqppButk9hBKlW4L11i7JFw3Y');
